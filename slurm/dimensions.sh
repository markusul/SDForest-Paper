...
do 
   ...
   #sbatch --time=128:00:00 --job-name="lim1 $i" --mem-per-cpu=2GB --output=outfiles/lim1_$i.out --cpus-per-task=100 --wrap "Rscript --vanilla simulation_study/limitations_1.r $i"
done